...
13. 数据库的锁分类？简单说说 [详细](https://cloud.tencent.com/developer/article/1523026)

- 乐观锁：在字段上加个version，每次更改数据的时候+1
- 悲观锁：
    - 共享锁：只允许事务并发读取上了锁的资源，无法修改，且无法和排它锁一起加 （... lock in share mode）
    - 排他锁：写锁，只允许加锁的事物读和写，其他事务无法访问数据，会阻塞其他所有类型锁，防止其他锁上写锁 （for update）
